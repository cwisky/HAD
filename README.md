...
* https://www.duplichecker.com/ko
  + 1000자씩 텍스트를 입력하여 [표절검사] 버튼을 누르면 검사하여 표절율을 계산해준다
  + 파일(docx, txt, pdf 등)을 업로드할 수 있으나 1000자가 넘으면 유료를 사용해야 함
  + 무료로 사용하려면 1000자씩 텍스트를 반복 입력하여 검사하면 되는데 그만큼 많은 시간이 걸리는 단점이 있다
